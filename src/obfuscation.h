...
{
public:
    /// Is the inputs associated with this public key? (and there is 15000 VDL - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of vidulum.
