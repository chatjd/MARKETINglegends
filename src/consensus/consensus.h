...
static const unsigned int MAX_BLOCK_SIZE_BEFORE_UPGRADE = 2000000;
static const unsigned int MAX_BLOCK_SIZE_AFTER_UPGRADE = 4000000;
...
static const unsigned int MAX_TX_SIZE_AFTER_DIFA = (2 * MAX_TX_SIZE_BEFORE_SAPLING);
