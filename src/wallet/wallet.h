...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT15000IFMN = 3,
    ONLY_NONDENOMINATED_NOT15000IFMN = 4, // ONLY_NONDENOMINATED and not 15000 VDL at the same time
...
public:
    ...
    /// Get 15000 VDL output and keys which can be used for the Masternode
