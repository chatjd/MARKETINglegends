...
const unsigned char VIDULUM_EXPANDSEED_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] = {'Z','c','a','s','h','_','E','x','p','a','n','d','S','e','e','d'};
...
std::array<unsigned char, 64> PRF_expand(const uint256& sk, unsigned char t)
{
    ...
    crypto_generichash_blake2b_init_salt_personal(&state, nullptr, 0, 64, nullptr, VIDULUM_EXPANDSEED_PERSONALIZATION);
