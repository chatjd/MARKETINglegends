...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Vidulum vidulum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vidulum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vidulum transaction") + "\n" +
              "  vidulum-tx [options] -create [commands]   " + _("Create hex-encoded vidulum transaction") + "\n" +
              "\n";
