...
#ifndef VIDULUM_PAYMENTDISCLOSURE_H
#define VIDULUM_PAYMENTDISCLOSURE_H
...
struct PaymentDisclosureInfo {
    ...
    uint256 esk;              // vidulum/NoteEncryption.cpp
...
struct PaymentDisclosurePayload {
    ...
    libzcash::SproutPaymentAddress zaddr; // vidulum/Address.hpp
