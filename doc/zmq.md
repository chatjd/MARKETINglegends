...
The ZeroMQ feature in Vidulum requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ vidulumd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/vidulumd.tx.raw
...
From the perspective of vidulumd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into vidulumd directly. Furthermore, no information is
