...
if [[ "$OSTYPE" == "darwin"* ]]; then
    PARAMS_DIR="$HOME/Library/Application Support/VidulumParams"
else
    PARAMS_DIR="$HOME/.vidulum-params"
fi
...
SPROUT_URL="https://github.com/vidulum/sapling-params/releases/download/sapling/"
...
Failed to fetch the Vidulum zkSNARK parameters!
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Vidulum zkSNARK parameters. Note that it is
